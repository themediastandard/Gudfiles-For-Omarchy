...
FEATURES = (
    Feature('browse', 'Folder tabs',
            'Use + or Ctrl + T for a new Files tab. Each tab keeps its folder history, view, filters, selection and scroll. Ctrl + W closes a tab; Ctrl + Shift + T reopens it. Drag tabs to reorder them.',
    ...
    Feature('browse', 'An app that follows your theme',
            'Files reads your active Omarchy colors at launch, including its previews, menus and dialogs.'),
    ...
    Feature('organize', 'Your labels stay local',
            'Ratings and colors belong to Files, not embedded media metadata. They follow renames and cut/paste moves made here; external moves are not tracked.',
    ...
    Feature('transfers', 'Transfers belong to this session',
            'Closing the Transfers panel keeps work running. Closing Files asks about unfinished work. The queue is not restored after relaunch. Dragging across disks copies automatically; cut/paste moves require the same filesystem.',
    ...
    Feature('locations', 'Open another Files window',
    ...
    Feature('picker', 'Files as your everyday browser',
            'When launched directly, Files opens files in their default apps and stays open. Escape clears the search or selection. There is no Open / Save footer in this mode.'),
