...
FEATURES = (
    ...
    Feature('browse', 'Selection summaries',
            'The slim bottom bar shows the selected file/folder count and combined size. Totals update in the background. Selecting a folder or document keeps the large media preview hidden, leaving more room for browsing.',
    ...
    Feature('organize', 'Restore from Trash',
            'Open Trash in the sidebar to browse deleted items and their original locations. Select items and use the restore button to put them back. Existing files are never replaced; failures stay in Trash. Back, Forward, tabs and name/location search work here too. F5 refreshes the list.',
