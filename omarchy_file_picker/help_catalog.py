...
FEATURES = (
    ...
    Feature('browse', 'Search this folder',
            'Click the magnifying glass or press Ctrl + F to search names in the current folder. Enter shows the results; Escape closes search without clearing the filter. Remove the Search chip to clear it. Search does not scan subfolders.', 'Ctrl + F', 'find filename'),
    ...
    Feature('browse', 'Sort & list details',
            'Use Sort in the top bar or right-click → Sort By. Newest first and Oldest first use date modified; name, size and type also sort in either direction. Folders first is optional. Your choice is remembered in new windows and Open/Save pickers. The View menu toggles list detail columns.'),
