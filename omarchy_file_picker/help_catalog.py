...
FEATURES = (
    ...
    Feature('create', 'Put a screenshot in a folder',
            'Copy a screenshot or another PNG image, then press Ctrl + V in a writable folder or right-click blank space and choose Put Screenshot Here. Right-click a folder to put it directly inside. Gudfiles keeps the clipboard unchanged and uses a new timestamped name without overwriting anything.',
            'Ctrl + V', 'clipboard png paste image'),
